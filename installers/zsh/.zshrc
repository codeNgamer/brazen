...
alias wd="source ~/scripts/workspacescript.sh"
alias editWorkSpaceScript="vim $HOME/scripts/workspacescript.sh"
alias changeWorkSpace="source $HOME/scripts/workspace.sh)"
alias cleanGitRepo="git branch --merged | grep -v "\*" | grep -v "master" | grep -v "develop" | grep -v "staging" | xargs -n 1 git branch -d"
